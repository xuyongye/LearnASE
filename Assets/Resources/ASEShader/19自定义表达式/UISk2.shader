...
Shader "YQQ/UISk"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			float2 IntervalFunc24( float2 XYSpeed, float Interval, float2 outValue )
			{
				outValue.x = fmod(XYSpeed.x, Interval) - 1;
				outValue.y = fmod(XYSpeed.y, Interval) - 1;
				return outValue;
			}
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 appendResult30 = (float2(_Float1 , _Float2));
				float2 XYSpeed24 = ( _Time.y * appendResult30 );
				float Interval24 = _Float3;
				float2 outValue24 = float2( 0,0 );
				float2 localIntervalFunc24 = IntervalFunc24( XYSpeed24 , Interval24 , outValue24 );
				...
				float2 lerpResult13 = lerp( ( texCoord4 + localIntervalFunc24 ) , temp_cast_0 , _Float0);
...
Node;AmplifyShaderEditor.SimpleTimeNode;26;-2418.813,-1.123493;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;23;-1901.79,-287.5824;Inherit;False;622.234;339.5624;旧无间隔的移动;3;3;4;6;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.PannerNode;3;-1484.556,-124.6454;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;6;-1793.153,-112.02;Inherit;False;Property;_addSpeed;叠加速度;3;0;Create;False;0;0;0;False;0;False;0,0.5;0,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
